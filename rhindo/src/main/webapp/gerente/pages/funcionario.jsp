	...
	<script type="text/javascript">
		$(function(){
			...
			$('#grid').w2grid({
				name: 'grid',
				url: {
					get: 'http://' + window.location.host + '/funcionario'
				},
				header: 'Funcionários',
				show: {
					toolbar: true,
				...
				columns: [
					{ field: 'idfuncionario', caption: 'Cód.', size: '10%' },
			...
			$("#form").w2form({ 
                ...
                name: 'form',
                fields: [
                    { name: 'idfuncionario', type: 'text', html: { caption: 'Cód.', attr: 'size="10" readonly' } },
                    ...
                    { name: 'numero', type: 'text', required: true, html: { caption: 'Número', attr: 'size="40" maxlength="40"' } },
